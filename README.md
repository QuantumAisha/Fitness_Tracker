...
```
{
  "canisters": {
    "fitness_tracker": {
      ...
      "candid_gen": "http",
      "build": "npx azle fitness_tracker",
      "wasm": ".azle/fitness_tracker/fitness_tracker.wasm",
      "gzip": true,
      "metadata": [
        {
            "name": "candid:service",
...
```
where `fitness_tracker` is the name of the canister. 
...
Example:
- `dfx canister id fitness_tracker`
Response:
```
...
### Download Postman
You can download Postman from [Postman Website](https://www.postman.com/downloads/).

### Import Postman Collection
To interact with the fitness_tracker canister, refer to the following documentation.

[![Run in Postman](https://run.pstmn.io/button.svg)](https://documenter.getpostman.com/view/31819605/2sA3XSA1GR)
